    ...
    <script src="../template/dist/js/pages/forms/select2/select2.init.js"></script> -->
    <script src="../web/reports/dist/ajax.js"></script>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(function() {
                $('input[name="daterange_trip"]').daterangepicker({
                    opens: 'left'
            ...
            $(function() {
                $('input[name="daterange_mp"]').daterangepicker({
                    opens: 'left'
                }, function(start, end, label) {
                    console.log("A new date selection was made: " + start.format('YYYY-MM-DD') + ' to ' + end.format('YYYY-MM-DD'));
                });
            ...
            $(function() {
                $('input[name="daterange_er"]').daterangepicker({
                    opens: 'left'
                }, function(start, end, label) {
                    console.log("A new date selection was made: " + start.format('YYYY-MM-DD') + ' to ' + end.format('YYYY-MM-DD'));
                });
            ...
            $(function() {
                $('input[name="daterange_idl"]').daterangepicker({
                    opens: 'left'
                }, function(start, end, label) {
                    console.log("A new date selection was made: " + start.format('YYYY-MM-DD') + ' to ' + end.format('YYYY-MM-DD'));
                });
            ...
            $(function() {
                $('input[name="daterange_att"]').daterangepicker({
                    opens: 'left'
                }, function(start, end, label) {
                    console.log("A new date selection was made: " + start.format('YYYY-MM-DD') + ' to ' + end.format('YYYY-MM-DD'));
                });
