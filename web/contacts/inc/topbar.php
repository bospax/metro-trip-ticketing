                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html">
                        ...
                        <b class="logo-icon">
                            ...
                            <!-- Dark Logo icon -->
                            <img src="../template/assets/images/metro_single.png" alt="homepage" class="dark-logo" />
                            <!-- Light Logo icon -->
                        ...
                        <span class="logo-text">
                             <!-- dark Logo text -->
                             <img src="../template/assets/images/metro_text.png" alt="homepage" class="dark-logo ext-logo-text" />
                             <!-- Light Logo text -->    
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                                ...
                                <div class="d-flex no-block align-items-center p-15 bg-primary text-white mb-2">
                                    <div class=""><img src="../template/assets/images/users/1.jpg" alt="user" class="img-circle" width="60"></div>
                                    <div class="ml-2">
