    ...
    <script src="../web/consump/dist/ajax.js"></script>
    ...
    <script>
        ...
        $(function() {
            $("#datepicker_consump").datepicker();
        });
        $(document).ready(function(){
            $('input#timepicker_trips').timepicker({
                interval: 15,
                timeFormat: 'hh:mm a'
            });
        });
        ...
        $(function() {
            $('input[name="daterange_consump"]').daterangepicker({
                opens: 'left'
